...
For installation instructions for Android, head [here](https://github.com/james15-spec/Cronix-browser/tree/main/android/README.md) or go onto the android folder in this repo and read the installation instructions.
